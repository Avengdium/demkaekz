...
public class AddRequestController {
    ...
    private ClientDAO clientDAO = new ClientDAO(); // Для доступа к методу добавления заявки в базу данных
    ...
    private void handleAddRequestButtonAction() {
        ...
        request.setProblemDescryption(problemDescriptionArea.getText());
    ...
    // Метод для установки экземпляра ClientDAO
